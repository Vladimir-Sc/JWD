...
function validateForm(theForm) {
   with(theForm) {
      ...
      return (isNotEmpty(txtImeprezime, "Unesite ime i prezime!", elmNameError)
           && isNotEmpty(txtKmpredjeni, "Unesite predjene kilometre", elmNameError)
           && isNotEmpty(txtVrememin, "Unesite vreme", elmNameError)
           && isSelected(selTip, "Izaberite tip ucesca!", elmTipUcescaError)
           && isChecked("tipUcesnika", "Izaberite tip ucesnika!", elmTipUcesnikaError)

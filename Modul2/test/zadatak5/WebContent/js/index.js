...
function validateForm(theForm) {
   with(theForm) {
      ...
      return (isNotEmpty(txtImeprezime, "Unesite ime i prezime!", elmImeError)
           && isNotEmpty(txtKmpredjeni, "Unesite predjene kilometre", elmKmError)
           && isNotEmpty(txtVrememin, "Unesite vreme", elmVremeError)

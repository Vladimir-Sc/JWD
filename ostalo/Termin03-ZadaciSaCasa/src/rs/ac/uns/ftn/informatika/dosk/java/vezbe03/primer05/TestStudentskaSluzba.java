...
public class TestStudentskaSluzba {
	...
	public static void ispisiPredmete(ArrayList<Predmet> lista){
		for (Predmet pr : lista) {
			System.out.println(pr.vratiTekstualnuReprezentacijuZaIspis());
		}
	}
	...
	public static void ispisiIspitneRokove(ArrayList<IspitniRok> lista){
		for (IspitniRok ir : lista) {
			System.out.println(ir.vratiTekstualnuReprezentacijuZaIspis());
		}
	}
	
	public static void ispisiSveOIspitniRoku(IspitniRok obj){
		System.out.println(obj.vratiTekstualnuReprezentacijuZaIspisAll());
	}
	...
	public static IspitniRok pratragaIspitniRoka(ArrayList<IspitniRok> lista, int id){
		IspitniRok obj = null;
		for (IspitniRok ir : lista) {
			if(ir.id == id){
				obj = ir;
	...
	public static void dodavanjeNovogIspitnogRoka(ArrayList<IspitniRok> lista){
		//URADI KOD
	}
	
	//za odabrani ispitni rok dodavanje ispitnih prijava se može pozivati N puta 
	public static void dodavanjeNoveIspitnePrijaveZaIspitniRok(IspitniRok ir, ArrayList<Predmet> listaPr, ArrayList<Student> listaSt ){
		//URADI KOD
	}
	
	//za odabranog studenta rok dodavanje ispitnih prijava se može pozivati N puta
	public static void dodavanjeNoveIspitnePrijaveZaStudenta(Student st, ArrayList<Predmet> listaPr, ArrayList<IspitniRok> listaIr ){
		//URADI KOD
	}
	...
	public static void izmenaIspitnogRoka(ArrayList<IspitniRok> lista){
		//URADI KOD
	}
	...
	public static void brisanjeIspitnogRoka(ArrayList<IspitniRok> lista){
		//URADI KOD
	}
	
	//za odabrani ispitni rok brisanje ispitnih prijava se može pozivati N puta
	public static void brisanjeIspitnePrijaveZaIspitniRok(IspitniRok ir, ArrayList<Predmet> listaPr, ArrayList<Student> listaSt ){
		//URADI KOD
	}
	
	//za odabranog studenta brisanje ispitnih prijava se može pozivati N puta
	public static void brisanjeIspitnePrijaveZaStudenta(Student st, ArrayList<Predmet> listaPr, ArrayList<IspitniRok> listaIr ){
		//URADI KOD
	}
	...
	public static void main(String[] args) {
		...
		//URADI KOD za ispitne rokove
		
		//uradi kod za ispitne prijave

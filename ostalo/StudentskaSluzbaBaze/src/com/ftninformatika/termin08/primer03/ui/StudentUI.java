...
public class StudentUI {
	...
	public static Student pronadjiStudenta() {
		...
		String stIndex = PomocnaKlasaDatumi.ocitajTekst();
		try {
	...
	public static void unosNovogStudenta() {
		...
		try {
			...
			String stIme = PomocnaKlasaDatumi.ocitajTekst();
			System.out.print("Unesi prezime: ");
			String stPrezime = PomocnaKlasaDatumi.ocitajTekst();
			System.out.print("Unesi grad: ");
			String stGrad = PomocnaKlasaDatumi.ocitajTekst();
	...
	public static void izmenaPodatakaOStudentu() {
		...
		if (student != null) {
			...
			String stIndeks = PomocnaKlasaDatumi.ocitajTekst();
